...
def get_add_gaussian_noise_function(gaussian_noise_mean = 0, gaussian_noise_standard_desviation = 0.2, min_value = 0, max_value = 1):

    """
    This function returns a function to add gaussian noise.
    inputs:
        gaussian_noise_mean : int -> Gaussian noise mean.
        gaussian_noise_standard_desviation : float -> Gaussian noise standard desviation.
        min_value : int -> minimum value in the output matrix.
    ...
    outputs:
        add_noise : function -> Function to add gaussian noise defined by inputs.
    """

    def add_noise(matrix):
        return add_gaussian_noise(matrix, 
                        gaussian_noise_mean = gaussian_noise_mean, 
                        gaussian_noise_standard_desviation = gaussian_noise_standard_desviation, 
                        min_value = min_value, 
                        max_value = max_value)
...
def get_add_uniform_noise_function(uniform_min_value = -0.5, uniform_max_value = 0.5, min_value = 0, max_value = 1):

    """
    This function returns a function to add uniform noise.
    inputs:
        matrix : numpy matrix -> A matrix to add gaussian noise.
        uniform_min_value : float -> Minimum value to use to generate a Uniform distribution.
        uniform_max_value : float -> Maximum value to use to generate a Univorm distribution.
    ...
    outputs:
        add_noise : function -> Function to add uniform noise defined by inputs.
    """

    def add_noise(matrix):
        return add_uniform_noise(matrix, 
                        uniform_min_value = uniform_min_value, 
                        uniform_max_value = uniform_max_value, 
                        min_value = min_value, 
                        max_value = max_value)
